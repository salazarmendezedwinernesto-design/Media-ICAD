  ...
  return (
    ...
    >
      ...
      {estado.reloj.visible && (
        <div style={estilosReceptor.reloj}>{formatearReloj(horaActual)}</div>
      )}
      ...
      <div style={estilosReceptor.centro}>
        {(estado.temporizador.activo ||
          ...
          <div
            style={{
              ...
              color: tiempoCumplido ? "#ef4444" : "#ffffff",
            }}
          >
        ...
        {estado.mensaje.visible && estado.mensaje.texto && (
          <div style={estilosReceptor.mensaje}>{estado.mensaje.texto}</div>
        )}
      </div>

      {estado.nota.texto && (
        <div style={estilosReceptor.nota}>{estado.nota.texto}</div>
      )}
    </div>
  );
}
